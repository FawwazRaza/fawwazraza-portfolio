  ...
  return (
    <div className="relative min-h-screen w-full py-20 lg:py-32">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
        <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-br from-cyan-300/30 to-blue-300/20 rounded-full filter blur-3xl animate-float"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-purple-300/30 to-pink-300/20 rounded-full filter blur-3xl animate-float-delayed"></div>
      </div>
      ...
      <div className="relative z-10 mx-auto w-[90%] max-w-[1800px]">
        ...
        {/* <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
          ...
          <p className="font-poppins text-lg text-slate-600 max-w-3xl mx-auto">
