          ...
          >
            ...
            <div className="relative w-full h-48 overflow-hidden">
              {imageData.type === 'gradient' ? (
                <div className={`w-full h-full bg-gradient-to-br ${imageData.color} opacity-30 flex items-center justify-center`}>
                  <FaGithub className="text-6xl text-white/40" />
                </div>
              ) : (
                <img
            ...
            <div className="p-6 lg:p-8 flex flex-col flex-grow">
              ...
              {isExpanded && hasExtendedInfo && (
                <div className="mb-6 space-y-4 animate-slide-in max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-cyan-500 scrollbar-track-gray-200">
                  {project.problem_solved && (
                    <div className="glass-card p-4 rounded-xl">
                      <h3 className="font-semibold text-lg text-slate-900 mb-2">Problem Solved</h3>
                      <p className="text-sm text-slate-700 break-words hyphens-auto">{project.problem_solved}</p>
                    </div>
                  )}
              ...
              <div className="mt-auto flex flex-wrap gap-3">
                ...
                {hasExtendedInfo && (
                  <button
                    type="button"
                    className="flex items-center justify-center gap-2 px-6 py-3 glass-card text-slate-900 rounded-xl font-semibold hover:scale-105 transition-all duration-300"
